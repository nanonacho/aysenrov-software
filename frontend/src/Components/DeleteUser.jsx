                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="staticBackdropLabel">¿Estás seguro de eliminar a {props.user.name} {props.user.lastname} ?</h1>
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" className="btn btn-danger" data-bs-dismiss="modal" onClick={e => handleRemoveClick(e, props.user._id)}>Eliminar</button>
                        </div>
                    </div>
                </div>
            </div>
